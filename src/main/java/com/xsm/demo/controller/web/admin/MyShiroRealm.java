package com.xsm.demo.controller.web.admin;
...
public class MyShiroRealm extends AuthorizingRealm{
    ...
    @Resource
    private TestUserInfoManager userInfoService;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        TestUserInfoExample userInfoExample = new TestUserInfoExample();
        userInfoExample.or().andUsernameEqualTo(username);
        TestUserInfo userInfo = userInfoService.selectOneByExample(userInfoExample);
        if(userInfo == null){
            return null;
        }
       /*
...
//      );
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        */
        ...
        TestUserInfo userInfo  = (TestUserInfo)principals.getPrimaryPrincipal();
...
//        }
        for(TestSysRole role:userInfo.getRoleList()){
            authorizationInfo.addRole(role.getRole());
            for(TestSysPermission p:role.getPermissions()){
